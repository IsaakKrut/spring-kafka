package com.isaakkrut.dispatch.integration;


import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicInteger;

import com.isaakkrut.dispatch.config.BeanConfig;
import com.isaakkrut.dispatch.config.KafkaConfig;
...
import static com.isaakkrut.dispatch.integration.WiremockUtils.stubWiremock;
...
@Slf4j
@SpringBootTest(classes = {KafkaConfig.class, BeanConfig.class})
...
public class OrderDispatchIntegrationTest {
     ...
     */
    @Test
    public void testOrderDispatchFlow_NotRetriableException() throws Exception {
